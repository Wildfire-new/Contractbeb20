...
contract Wynaut is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7000000 * 10 ** uint256(_decimals);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Wildfire';
    string private constant _symbol = 'WDF';
    
    uint256 private _taxFee = 180;
    uint256 private _burnFee = 180;
    uint private _max_tx_size = 70000 * 10 ** uint256(_decimals);
